...
class WebGuardException(HTTPException):
    """WebGuard 基础异常类"""
    def __init__(self, status_code: int = 400, detail: str = "错误", code: int = 40001):
