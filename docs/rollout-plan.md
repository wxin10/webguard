...
- Web access token localStorage compatibility path must be migrated or production-gated.
...
- P2-I should remove or production-gate the Web access token localStorage compatibility path.
